            ...
            <div className="flex h-14 items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                <nav className="flex gap-6 text-sm font-medium text-slate-700 dark:text-slate-300">
                  <Link href="/#about" className="hover:text-slate-900 dark:hover:text-slate-100 hidden md:inline">About</Link>
                  <Link href="/#talks" className="hover:text-slate-900 dark:hover:text-slate-100 hidden md:inline">Talks</Link>
                  <Link href="/#books" className="hover:text-slate-900 dark:hover:text-slate-100 hidden md:inline">Books</Link>
