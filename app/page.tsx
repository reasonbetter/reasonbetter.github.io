        ...
        <div className="mx-auto max-w-5xl px-4 py-16 hidden md:flex items-center justify-between gap-8">
          <div className="flex-1">
            ...
            <div className="mt-6 flex flex-wrap gap-3 items-center">
              <a className="inline-flex items-center rounded-md bg-white text-slate-900 border border-slate-300 px-4 py-2 text-sm font-medium hover:bg-slate-50 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200 shadow-sm"
              ...
              <button
                ...
                className="inline-flex items-center rounded-md bg-white text-slate-900 border border-slate-300 px-4 py-2 text-sm font-medium hover:bg-slate-50 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200 shadow-sm"
              >
                {copiedDesktop ? (
                  <>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
