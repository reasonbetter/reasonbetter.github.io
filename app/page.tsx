          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-5">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center">
                ...
                <button onClick={() => copyEmail(setCopiedDesktop)} className={`ml-3 text-sm md:text-base hover:underline ${copiedDesktop ? 'text-green-700 dark:text-green-400' : 'text-slate-700 dark:text-slate-300'}`}>
              ...
              <div className="flex items-center">
                ...
                <a href="https://calendar.app.google/huGbAtsbdEhxYGRh8" target="_blank" rel="noreferrer" className="ml-3 text-sm md:text-base text-slate-700 dark:text-slate-300 hover:underline">
                  Book a meeting
                </a>
              </div>
              <div className="flex items-center">
                ...
                <div className="ml-3 text-sm md:text-base text-slate-700 dark:text-slate-300 whitespace-nowrap">
