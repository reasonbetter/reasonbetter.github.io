              ...
              <article key={idx} className="rounded-lg border border-slate-200 dark:border-slate-800 p-5 md:p-6 shadow-sm transition-shadow hover:shadow-md flex flex-col">
                ...
                <div className="mt-auto pt-4">
                  <div className="flex justify-between items-end gap-2">
                    ...
                    {p.link && (
                      <a className="inline-flex items-center rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-900 flex-shrink-0 whitespace-nowrap"
