  ...
  return (
    <main>
      ...
      <section id="about" className="scroll-mt-24 border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20 grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-9">
            <h2 className={`text-[1.6rem] md:text-[1.95rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>About</h2>
        ...
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1">
              <h2 className={`text-[1.6rem] md:text-[1.95rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Recent Talks</h2>
      ...
      <section id="books" className="scroll-mt-24 border-b border-slate-200 dark-border-slate-800">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20">
          <h2 className={`text-[1.6rem] md:text-[1.95rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Books</h2>
      ...
      <section id="research" className="scroll-mt-24 border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20">
          <h2 className={`text-[1.6rem] md:text-[1.95rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Papers</h2>
      ...
      <section id="teaching" className="scroll-mt-24 border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20">
          <h2 className={`text-[1.6rem] md:text-[1.95rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Upcoming Courses</h2>
          <p className="mt-3 max-w-3xl text-slate-700 dark:text-slate-300">
      ...
      <footer id="contact" className="scroll-mt-24 bg-slate-50 dark:bg-slate-900">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-20">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className={`text-[1.3rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Elsewhere</h2>
            ...
            <div>
              <h2 className={`text-[1.3rem] font-semibold tracking-[0.01em] ${titleFont.className}`}>Get in touch</h2>
